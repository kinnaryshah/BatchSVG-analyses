 ...
 * Pipeline parameters
 */
params.data_name = 'spatialLIBD_DLPFC_12_3_7_12_expanded_sig'
params.batch = "subject"
params.dev_thres = 7
params.rank_thres = 10
params.bias_csv = "./results/spatialLIBD_DLPFC_12_3_7_12_expanded_sig_subject_7_7_bias_genes.csv"
