...
process download_data {
    ...
    spe <- read10xVisium(here("SpatialBenchVisium_708_709_713/preprocessed/OCT_CytAssist_WT_709/outs/"),
    ...
    spe <- read10xVisium(here("SpatialBenchVisium_708_709_713/preprocessed/OCT_WT_708/outs/"),
                     type = "sparse",   # use sparse (not HDF5) format
                     data = "raw",     
                     images = "lowres", # specify which image(s) to include
                     load = TRUE)      # specify whether or not to load image(s)
    ...
    spe <- read10xVisium(here("SpatialBenchVisium_708_709_713/preprocessed/FFPE_2_WT_713/outs/"),
                     type = "sparse",   # use sparse (not HDF5) format
                     data = "raw",     
                     images = "lowres", # specify which image(s) to include
                     load = TRUE)      # specify whether or not to load image(s)
    ...
    spe <- read10xVisium(here("SpatialBenchVisium_708_709_713/preprocessed/OCT_CytAssist_WT_713/outs/"),
                     type = "sparse",   # use sparse (not HDF5) format
                     data = "raw",     
                     images = "lowres", # specify which image(s) to include
                     load = TRUE)      # specify whether or not to load image(s)
    ...
    spe <- read10xVisium(here("SpatialBenchVisium_708_709_713/preprocessed/FFPE_CytAssist_WT_713/outs/"),
                     type = "sparse",   # use sparse (not HDF5) format
                     data = "raw",     
                     images = "lowres", # specify which image(s) to include
                     load = TRUE)      # specify whether or not to load image(s)
    ...
    spe7 <- spe7[which(rownames(spe7) %in% overlap_genes),]
    spe8 <- spe8[which(rownames(spe8) %in% overlap_genes),]
    spe9 <- spe9[which(rownames(spe9) %in% overlap_genes),]

    spe <- cbind(spe1,spe2,spe3,spe4,spe5,spe6,spe7,spe8,spe9)
    ...
    save(spe, file=here("SpatialBenchVisium_708_709_713","results", "SpatialBenchVisium_708_709_713_spe_qc.Rdata"))
    """
}
