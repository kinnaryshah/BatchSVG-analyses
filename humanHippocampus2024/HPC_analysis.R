...
pca1_sample <- plot_hexbin_meta(hex, col = "sample_id", action = "majority", xlab = "PC1 (67.38%)", ylab = "PC2 (25.00%)") +
  ggtitle("Before BatchSVG") + theme(legend.position = "right") 
...
pca2_sample <- plot_hexbin_meta(hex, col = "sample_id", action = "majority", xlab = "PC1 (68.02%)", ylab = "PC2 (25.13%)") +
  ggtitle("After BatchSVG") + theme(legend.position = "right") 
