...
process download_data {
    ...
    spe <- read10xVisium(here("SpatialBenchVisium_709_713_FFPE/preprocessed/FFPE_2_WT_709/outs/"),
    ...
    spe <- read10xVisium(here("SpatialBenchVisium_709_713_FFPE/preprocessed/FFPE_CytAssist_WT_709/outs/"),
                     type = "sparse",   # use sparse (not HDF5) format
                     data = "raw",     
                     images = "lowres", # specify which image(s) to include
                     load = TRUE)      # specify whether or not to load image(s)
    ...
    spe <- read10xVisium(here("SpatialBenchVisium_709_713_FFPE/preprocessed/FFPE_2_WT_713/outs/"),
                     type = "sparse",   # use sparse (not HDF5) format
                     data = "raw",     
                     images = "lowres", # specify which image(s) to include
                     load = TRUE)      # specify whether or not to load image(s)
    ...
    spe <- read10xVisium(here("SpatialBenchVisium_709_713_FFPE/preprocessed/FFPE_CytAssist_WT_713/outs/"),
                     type = "sparse",   # use sparse (not HDF5) format
                     data = "raw",     
                     images = "lowres", # specify which image(s) to include
                     load = TRUE)      # specify whether or not to load image(s)
    ...
    save(spe, file=here("SpatialBenchVisium_709_713_FFPE","results", "SpatialBenchVisium_709_713_FFPE_spe_qc.Rdata"))
    """
}
