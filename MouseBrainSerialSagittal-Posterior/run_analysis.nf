 ...
 * Pipeline parameters
 */
params.data_name = 'MouseBrainSerialSagittal-Posterior'
params.batch = "sample_id"
params.dev_thres = 4
params.rank_thres = 7
params.bias_csv = "./results/MouseBrainSerialSagittal-Posterior_sample_id_4_7_bias_genes.csv"
...
workflow {
    ...
    // assume I've run 2 .sh scripts

    // download_data(params.data_name)

    // run nnSVG.sh on JHPCE cluster
