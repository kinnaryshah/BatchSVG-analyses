...
svgs_after <- read.csv(file = here(data_name, "results", paste0(data_name, "_subject_7_7_filt_svgs.csv")))
...
save(spe, file = here(data_name, "results", paste0(data_name, "_spe_PRECAST_postBatchSVG_7.Rdata")))
