...
n_rank <- apply(res_ranks, 1, function(r) sum(r < 3000, na.rm = TRUE))
...
write.csv(df_summaryReplicated, here(data_name, "results", paste0(data_name, "_expanded_sig_svgs.csv")))
